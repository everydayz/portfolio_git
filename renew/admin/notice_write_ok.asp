...
If Trim(nSeq&"")<>"" Then			'//수정모드
	...
	objDb.SetAddParam "@nIsUrl"				,objDb.getVal("Tinyint")		,adParamInput	,4					,nIsUrl
	objDb.SetAddParam "@strSource"			,objDb.getVal("NVarChar")	,adParamInput	,200				,strSource
