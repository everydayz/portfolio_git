...
Dim strListPage : strListPage = "notice_list.asp"
Dim strViewPage : strViewPage = "notice_view.asp"
...
'//이전글, 다음글
strSQL = "Exec ADM_Notice_PrevNext " & nSeq & " ,'" & req_category & "','" & req_keyword & "'"
Set cmdRs = objDb.CmmReQuery(adCmdText, strSQL)
...
<!--#include virtual="/admin/inc/inc_top.asp" -->
		  <table width="680" border="0" cellpadding="0" cellspacing="0">
			<form name="frmWrite" method="post" action="notice_write.asp" onsubmit="return fncInputNOTICE('<%=strMode%>')">
			...
			<input type="hidden" name="keyword" id="keyword" value="<%=req_keyword%>" />
              ...
              <tr> 
                <td><table width="101" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td><a href="#" onclick="fncMovePageNotice('U','<%=nSeq%>')"><img src="./images/03_board/btn_modify.jpg" width="48" height="20" border="0"></a></td>
                      <td width="5">&nbsp;</td>
                      <td><a href="#" onclick="fncMovePageNotice('D','<%=nSeq%>')"><img src="./images/03_board/btn_del.jpg" width="48" height="20" border="0"></a></td>
                      <td width="5">&nbsp;</td>
                      <td><a href="#" onclick="fncMovePageNotice('L','<%=nPage%>')"><img src="./images/03_board/btn_list.jpg" width="48" height="20" border="0"></a></td>
                    </tr>
                  </table></td>
              </tr>
			  </form>
