...
Dim strDepthTitle	: strDepthTitle = "하이패스담청자"
Dim req_seq

Dim strListPage : strListPage = "hipass_success_list.asp"
...
'리스트 총 갯수
strSQL = "Exec ADM_HIPASS_SUCCESS_Count '"  & category & "','"& keyword  & "'"
...
'리스트
strSQL = "Exec ADM_HIPASS_SUCCESS_List " & (nPage*nPageSize) &"," & RowPage & ",'" & category  & "','" & keyword  & "'"
...
<!--#include virtual="/wixi_admn/inc/inc_top.asp" -->
			<table width="680" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td>
                  <table width="500" border="0" cellpadding="1" cellspacing="1" bgcolor="#E4E4E4">
                    <tr bgcolor="#F0F0F0" class="event_popup"> 
                      <td width="50" height="27" align="center">번호</td>
                      <td width="100" align="center">이름</td>
                      <td width="100" align="center">연락처</td>
                      <td width="100" align="center">참석요일</td>
					  <td width="150" align="center">당첨일</td>
                    </tr>		<%
			isNullList = True
			'리스트
		...
		%>
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="center"><%=row("dRegDate")%></td>
                    </tr>
		<%
						Set row = Nothing
						vnum = vnum-1
		...
		%>
			...
			<form name="fXls" id="fXls" method="post" action="hipass_success_excel.asp">
