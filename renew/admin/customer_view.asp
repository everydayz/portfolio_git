...
'//이전글, 다음글
strSQL = "Exec ADM_CUSTOMER_PrevNext " & nSeq & " ,'" & req_category & "','" & req_keyword & "'"
Set cmdRs = objDb.CmmReQuery(adCmdText, strSQL)
...
<!--#include virtual="/admin/inc/inc_top.asp" -->
		  <table width="680" border="0" cellpadding="0" cellspacing="0">
			<form name="frmWrite" method="post" action="<%=strWritePage%>" onsubmit="return fncInputCustomer('<%=strMode%>')">
			...
			<input type="hidden" name="keyword" id="keyword" value="<%=req_keyword%>" />
              ...
              <tr> 
                <td><table width="101" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td><a href="#" onclick="fncMovePageCustomer('U','<%=nSeq%>')"><img src="./images/03_board/btn_modify.jpg" width="48" height="20" border="0"></a></td>
                      <td width="5">&nbsp;</td>
                      <td><a href="#" onclick="fncMovePageCustomer('D','<%=nSeq%>')"><img src="./images/03_board/btn_del.jpg" width="48" height="20" border="0"></a></td>
                      <td width="5">&nbsp;</td>
                      <td><a href="#" onclick="fncMovePageCustomer('L','<%=nPage%>')"><img src="./images/03_board/btn_list.jpg" width="48" height="20" border="0"></a></td>
                    </tr>
                  </table></td>
              </tr>
			  </form>
