...
'리스트
strSQL = "Exec ADM_CUSTOMER_MOBILE_LIST " & (nPage*nPageSize) &"," & RowPage & ",'" & category  & "','" & keyword  & "'"
...
<!--#include virtual="/wixi_admn/inc/inc_top.asp" -->
		...
		%>
                    <tr bgcolor="#ffffff">
                        ...
                        <td><a href="<%=strViewPage%>?page=<%=nPage%><%=strParam%>&amp;seq=<%=row("seq")%>"><%=f_stringCut(row("u_nm"),68)%></a><%=img_new%></td>
		...
		%>
              ...
              <tr> 
                <td><table width="680" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <!--
					  <a href="<%=strWritePage%>"><img src="./images/03_board/btn_write.jpg" width="48" height="20" border="0"></a>
					  -->
						</td>
                    </tr>
                  </table></td>
			...
			<form name="fXls" id="fXls" method="post" action="customer_mobile_excel.asp">
