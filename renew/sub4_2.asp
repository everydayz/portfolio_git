...
<div id="sub_wrap" style="width:100% !important">
	<div id="sub_bg">
		...
		<div id="sub_left">
			...
			<ul>
				<li><a href="sub4_1.asp">단지설계</a></li>
				
				<li><a href="sub4_3.asp">커뮤니티</a></li>
				<li><a href="sub4_4.asp">시스템</a></li>
                <li><a href="sub4_2.asp">동·호수 배치도</a></li>
			</ul>
		...
		<div id="sub_right">
			<div id="sub_title">HOME > 단지정보 > 동,호수 배치도</div>
			<div id="title">
				<div id="title01">
					<ul>
						<li><span>동,호수 배치도</span></li>						
					</ul>
				</div>
				<div id="title02">
...
function DisplayMenu(index) {
        ...
        thisMenu.display = "";
		img.src="img/sub5_tab_over0"+i+".jpg";
		
        }
        else {
        otherMenu = eval("menu" + i + ".style");
        otherMenu.display = "none";
		img.src="img/sub5_tab_0"+i+".jpg";
  ...
  <tr>
    ...
    <td align="left" valign="top" style="cursor:hand"><img src="img/sub5_tab_over01.jpg" name="pro1" id="pro1" onClick="DisplayMenu(1)"/></td>
    <td width="3" align="left" valign="top" ></td>
    <td align="left" valign="top" style="cursor:hand"><img src="img/sub5_tab_02.jpg"  name="pro2" id="pro2" onClick="DisplayMenu(2)"/></td>
      ...
      <img src="img/sub5_main01.jpg" width="733"   usemap="#Map01"/></div>
     <div id="menu2" style="display:none">
     <img src="img/sub5_main02.jpg" width="733" usemap="#Map02" /></div>
        </td>
          </tr>
</table>
